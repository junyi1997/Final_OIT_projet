...
class MyApp(object):
    ...
    def __init__(self, parent):
        ...
        self.GUI_IN=40#馬達IN1
        self.GUI_紙類=23#馬達IN2 藍
        self.GUI_塑膠=24#馬達IN3 黑
        self.GUI_鐵=26#馬達IN4   白
        self.GUI_a=0
        self.GUI_b=0
        self.GUI_c=0
...
#        win_HOW.attributes("-fullscreen", True)
        ...
        but_BZ=tk.Button(win_HOW,image=win_HOW.BZ) 

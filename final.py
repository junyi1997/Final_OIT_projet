        ...
        if self.tit == "Google":
            ...
            for i in range(self.sumi_1_1,self.sumi_1):
                ...
                users_ref.child(A).set({
                        'sum1':i+1,
                        'name': self.save1[self.sumi_1-self.sumi_1_1],
                        'SCoin': self.save2[self.sumi_1-self.sumi_1_1],
                        'time':self.save3[self.sumi_1-self.sumi_1_1]
                })
            ...
            for i in range(self.sumi_2_1,self.sumi_2):
                ...
                users_ref.child(A).set({
                        'sum1':i+1,
                        'name': self.save1[self.sumi_2-self.sumi_2_1],
                        'SCoin': self.save2[self.sumi_2-self.sumi_2_1],
                        'time':self.save3[self.sumi_2-self.sumi_2_1]
                })
            ...
            for i in range(self.sumi_3_1,self.sumi_3):
                ...
                users_ref.child(A).set({
                        'sum1':i+1,
                        'name': self.save1[self.sumi_3-self.sumi_3_1],
                        'SCoin':self.save2[self.sumi_3-self.sumi_3_1],
                        'time':self.save3[self.sumi_3-self.sumi_3_1]
                })
...
if __name__ == "__main__":
    ...
    app = MyApp(win)
    users_ref = db.reference('/Google')
    app.sumi_1_1=app.sumi_1=len(users_ref.get())
    users_ref = db.reference('/QR')
    app.sumi_2_1=app.sumi_2=len(users_ref.get())
    users_ref = db.reference('/fb')
